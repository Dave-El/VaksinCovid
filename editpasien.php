          ...
          ?>
            <form action="koneksi.php" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="form-check">
                  <input type="radio" class="form-check-input" name="status" value="positif" <?php if (($row['status']) === "positif") { echo "checked"; } ?>> Positif
                </div>
                <div class="form-check">
                  <input type="radio" class="form-check-input" name="status" value="negatif" <?php if (($row['status']) === "negatif") { echo "checked"; } ?>> Negatif
                </div>
              </div>
              <div class="form-group mt-3">
